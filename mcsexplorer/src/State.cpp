...
int State::get_interference_laxity(int target_crit, size_t i) const {
...
float State::get_interference_laxity_float(int target_crit, size_t i) const {
    // experimental
    if (target_crit < crit) return 999999999.0;
